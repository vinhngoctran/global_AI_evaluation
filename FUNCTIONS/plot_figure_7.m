function plot_figure_7()
%%
close all;
load('RESULTS_FINAL\R3_NearingNSE.mat',"NSEvalue","NSEmark","BasinInfo");
NSEvalue1 = NSEvalue;
load('RESULTS_FINAL\R3_NearingNSE_gauged.mat',"NSEvalue");
NSEvalue2 = NSEvalue;
...
%     exportgraphics(figure1,"Figures4/F7.jpg",'Resolution',600)
% exportgraphics(figure1, "Figures4/F7.pdf", 'ContentType', 'vector');
