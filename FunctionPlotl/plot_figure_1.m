...
display(['N of natural series = ',num2str(numel(NSEval)),'   ; Number of NSE>=0.5: ',num2str(numel(find(NSEval>=0.5))),'    ; Median NSE: ',num2str(median(NSEval,'omitnan')), '   ; Porpotion of NSE<0.5: ',num2str(numel(find(NSEval<0.5))/numel(NSEval))])
...
NSEval = NSEval(~any(isnan(NSEval), 2), :);
display(['N of dammed series = ',num2str(numel(NSEval)),'   ; Number of NSE>=0.5: ',num2str(numel(find(NSEval>=0.5))),'    ; Median NSE: ',num2str(median(NSEval,'omitnan')), '   ; Porpotion of NSE<0.5: ',num2str(numel(find(NSEval<0.5))/numel(NSEval))])
...
%     exportgraphics(figure1,"Figures2/F1.jpg",'Resolution',600)
% exportgraphics(figure1, "Figures2/F1.pdf", 'ContentType', 'vector');
