...
title("a US(32)",'FontSize',13,'VerticalAlignment','baseline');axes1.TitleHorizontalAlignment = 'left'
...
set(axes1,'Linewidth',1.5,'FontSize',11,'XColor',Col(2,:),'YColor',Col(2,:),...
    'Xtick',[-1:0.5:1],'Ytick',[-1:0.5:1])
title("b GB(139)",'FontSize',13,'VerticalAlignment','baseline');axes1.TitleHorizontalAlignment = 'left'
...
% exportgraphics(figure1,"Figures2/F3.jpg",'Resolution',600)
